...
from problems.scheduling.neighborhood import TaskReassignmentNeighborhood
...
class TaskSchedulingInstance:
    ...
    def _generate_feasible_solution(self) -> ProblemSolution:
        ...
        for _ in range(max_attempts):
            candidate = [random.randint(0, self.num_workers - 1) for _ in range(num_tasks)]
...
#        return True
    ...
    def obj(self, solution: list[ProblemSolution]) -> list[float]:
        return self.objective.obj(solution)
